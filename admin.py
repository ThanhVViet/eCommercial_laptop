...
admin = Admin(app=app, name="TVT SHOP", template_mode='bootstrap4')
...
class UserModelView(AuthenticatedView):
    ...
    column_filters = ("receipt", "ship", "name", "username", Receipt.id, Order.id)
    column_default_sort = [("id", True)]
    column_searchable_list = ("name", "username", "phone", "email", Receipt.id, Order.id)
...
class ProductModelView(AuthenticatedView):
    ...
    "name", "price", "brand_id", "image", "amount", "screen", "chip", "ram", "rom", "weight", "description")
    column_filters = (
    "name", "price", "brand_id", "image", "amount", "screen", "chip", "ram", "rom", "weight", "detail")
    column_default_sort = [("id", True), ("price", True), ("amount", True), ("ram", True), ("rom", True),
                           ("weight", True)]

    column_searchable_list = ("name", "screen", "chip", "ram", "rom", "weight", "price")
    can_set_page_size = True
...
class ReceiptModelView(AuthenticatedView):
    ...
    column_filers = ("detail", "ship", "product", "user_id", "user", Users.name)
    column_default_sort = [("id", True), ("user_id", True)]
    column_searchable_list = ("id", Users.name)
    can_set_page_size = True
...
class ReceiptDetailModelView(AuthenticatedView):
    ...
    column_searchable_list = ("product_id", "quantity", "unit_price")
    can_set_page_size = True
